...
public class Display extends JComponent{
	...
	private static void drawEdges(Graphics g, int x, int y) {
		...
		g.drawLine(Main.xoffset + x*16, findY(y) - 16, Main.xoffset + x*16, findY(y) -1);
		g.drawLine(Main.xoffset + x*16, findY(y) - 1, Main.xoffset + x*16 + 16 -1, findY(y) -1);
		g.drawLine(Main.xoffset + x*16 + 16 -1, findY(y) -1, Main.xoffset + x*16 + 16 -1, findY(y) - 16);
		g.drawLine(Main.xoffset + x*16 + 16 -1, findY(y) - 16, Main.xoffset + x*16, findY(y) - 16);
	}
