...
public class MyComplexTest {
	...
	public static void main(String args[]) {
		...
		System.out.println("Testing getReal: " + complex.getReal()); //calls getReal
		System.out.println("Testing getImag: " + complex.getImag()); //calls getImag
		System.out.println("Testing toString: " + complex); //implicitly calls toString
		...
		System.out.println("Current real: " + complex.getReal()); //finds number with getReal
		complex.setReal(5); //changes the real with setReal
		System.out.println("Changed radius: " + complex.getReal());  //finds number with getReal
		System.out.println();
		
		System.out.println("Testing setImag");
		System.out.println("Current real: " + complex.getImag()); //finds number with getImag
		complex.setImag(5); //changes the imaginary with setImag
		System.out.println("Changed radius: " + complex.getImag()); //finds number with getImag
		System.out.println();

		System.out.println("Testing setValue");
		System.out.println("Current values: " + complex); //finds number by implicitly calling toString 
		complex.setValue(6, 6); //changes the values with setValue
		System.out.println("Changed radius: " + complex); //finds number by implicitly calling toString 
		System.out.println();

		System.out.println("Testing add");
		System.out.println("Current values: " + complex); //finds number by implicitly calling toString 
		complex.add(another); //adds the complex number by `another` with multiplyWith
		System.out.println("Changed values: " + complex); //finds number by implicitly calling toString 
		System.out.println();

		System.out.println("Testing subtract");
		System.out.println("Current real: " + complex); //finds number by implicitly calling toString
		complex.subtract(another); //subtracts the complex number by `another` with divideBy
		System.out.println("Changed values: " + complex); //finds number by implicitly calling toString
		...
		System.out.println("Testing isReal: " + complex.isReal()); //calls isReal
		System.out.println("Testing isImaginary: " + complex.isImaginary()); //calls isImaginary
		System.out.println("Testing equals: " + complex.equals(another)); //calls equals
		System.out.println("Testing magnitude: " + complex.magnitude()); //calls magnitude
		System.out.println("Testing argumentInRadians: " + complex.argumentInRadians()); //calls argumentInRadians
		System.out.println("Testing arguemntInDegrees: " + complex.argumentInDegrees()); //calls argumentInDegrees
	}
}
